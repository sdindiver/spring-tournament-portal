...
import static com.bo.tournament.versioned.ApiVersionHeader.LATEST;
...
public class ApiVersionAnnotationParser {
    ...
    public Map<Method, List<RequestMappingInfo>> parseApiVersioningAnnotations(Map<Method, RequestMappingInfo> originalMappings) {
